...
export interface ApiResumeofuserResumeofuser
  extends Struct.CollectionTypeSchema {
  collectionName: 'resumeofusers';
  info: {
    description: '';
    displayName: 'Resumeofuser';
    pluralName: 'resumeofusers';
    singularName: 'resumeofuser';
  };
  options: {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::resumeofuser.resumeofuser': ApiResumeofuserResumeofuser;
